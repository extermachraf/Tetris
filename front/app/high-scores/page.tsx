        ...
        <div className="content-card">
                ...
                <tbody>
                  {highScores.map((score, index) => (
                    ...
                    >
                      ...
                      <td className="score-cell font-pixel text-sm">
                        {score.username}
                      </td>
                      <td className="score-cell score-value">
                        {score.score.toLocaleString()}
                      </td>
          ...
          <div className="content-section mt-10">
            ...
            <div className="flex border-b border-gray-800 mb-6">
              <button className="px-4 py-2 text-cyan-400 border-b-2 border-cyan-400 font-pixel text-xs">
                CLASSIC
              </button>
              <button className="px-4 py-2 text-gray-400 hover:text-gray-300 font-pixel text-xs">
                SPRINT
              </button>
              <button className="px-4 py-2 text-gray-400 hover:text-gray-300 font-pixel text-xs">
                BATTLE
            ...
            <p className="text-gray-300 mb-6">
              These are the top scores for the Classic game mode. Switch tabs to
              view other game modes.
            </p>
          </div>
